...
private val DarkColorScheme = darkColorScheme(
    ...
    onSecondary = SophisticatedPrimary,
    background = SophisticatedBg,
    onBackground = SophisticatedOnSurface,
    surface = SophisticatedSurface,
    onSurface = SophisticatedOnSurface,
    surfaceVariant = SophisticatedSecondary,
    onSurfaceVariant = SophisticatedHighlight,
...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimaryContainer = SophisticatedPrimary,
    secondary = SophisticatedSecondary,
    onSecondary = SophisticatedOnSurface,
    background = SophisticatedBg,
    onBackground = SophisticatedOnSurface,
    surface = SophisticatedSurface,
    onSurface = SophisticatedOnSurface,
...
fun MyApplicationTheme(
    ...
    // Keep dynamic color capability on but default to custom if needed
